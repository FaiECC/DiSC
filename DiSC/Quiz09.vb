Public Class Quiz09
    ...
    Public most() As Integer = Quiz08.most  'Array for keeping most value
    Public least() As Integer = Quiz08.least 'Array for keeping least value
    ...
    Dim Quiz() As String = {"Seeks balance, Calm", "Talkative, Charismatic",
                            "Orderly, Follows the rules", "Fast paced, High spirited"}


    'Load Event
    Private Sub Quiz09_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    'Form Closing
    Private Sub Quiz09_FormClosing _
