Public Class Quiz10
    ...
    Public most() As Integer = Quiz09.most  'Array for keeping most value
    Public least() As Integer = Quiz09.least 'Array for keeping least value
    ...
    Dim Quiz() As String = {"Likes awards, Accomplishments", "Enjoys social, Group gatherings",
                            "Continues education, Cultured", "Wants to be safe, Unthreatened"}

    'Load Event
    Private Sub Quiz10_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    'Form Closing
    Private Sub Quiz10_FormClosing _
