Public Class Quiz04
    ...
    Public most() As Integer = Quiz03.most  'Array for keeping most value
    Public least() As Integer = Quiz03.least 'Array for keeping least value
    ...
    Dim Quiz() As String = {"Unafraid, Independent", "Reserved, Cautious restraint",
                            "Carefree, Lacks caution", "Kind, Cordial"}


    'Load Event
    Private Sub Quiz04_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Quiz04_FormClosing _
