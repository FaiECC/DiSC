Public Class Quiz02
    ...
    Public most() As Integer = Quiz01.most  'Array for keeping most value
    Public least() As Integer = Quiz01.least 'Array for keeping least value
    ...
    Dim Quiz2() As String = {"Affectionate, Tender", "Simple, Compliant",
                            "Determined, Wants results", "Content, Gratified"}


    'Load Event
    Private Sub Quiz02_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        For i As Integer = 0 To 3
            Controls("Label" & CStr(i + 1)).Text = Quiz2(i)
        Next i
    ...
    Private Sub BackButton_Click _
        (sender As Object, e As EventArgs) Handles BackButton.Click
    ...
    Private Sub Quiz02_FormClosing _
