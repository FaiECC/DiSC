Public Class Quiz11
    ...
    Public most() As Integer = Quiz10.most  'Array for keeping most value
    Public least() As Integer = Quiz10.least 'Array for keeping least value
    ...
    Dim Quiz() As String = {"Systematic, Time management", "Anxious, Hurried",
                            "Dependable, Persistent", "Emotional, Impulsive"}

    'Load Event
    Private Sub Quiz11_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    'Form Closing
    Private Sub Quiz11_FormClosing _
